...
def store_rebound_control(goalie_stats):
    ...
    for _, row in goalie_stats.iterrows():
        record = {
            ...
            'regressed_adjrp_c5000': float(row['regressed_adjrp_c5000']) if pd.notna(row['regressed_adjrp_c5000']) else None,
            'regressed_adjrp_c10000': float(row['regressed_adjrp_c10000']) if pd.notna(row['regressed_adjrp_c10000']) else None,
            'league_mean_adjrp': float(row['league_mean_adjrp']) if pd.notna(row['league_mean_adjrp']) else None,
